...
requirements_agent = Agent(
    ...
    description=(
        ...
        "and missing information, and asks clarifying questions for Product Manager validation."
    ),
    instruction=(
        '''
        ...
        1. Extract, normalize, and present all stated business requirements in clear, concise language for the Product Manager to review.\n
            List the requirements in a numbered format and order them in the flow of user interaction or system behavior as implied by the text.\n
...
user_story_agent = Agent(
    ...
    instruction=(
        ...
        - If requirements are unclear or incomplete, STOP and flag the issue for Product Manager clarification.\n\n
        ...
        ### Stop condition:\n
        - If any requirement cannot be confidently converted into a story, explicitly state why and request PM clarification before proceeding.
        '''
    ),
)
...
test_case_agent = Agent(
    ...
    description=(
        "Generates functional test cases for user stories, covering happy paths and negative paths with clear traceability."
    ),
    instruction=(
        '''
        ...
        ### Stop condition:\n
        - If test coverage is limited due to unclear or weak acceptance criteria, explicitly call this out for Product Manager consideration.
        '''
    ),
)
...
root_agent = Agent(
    ...
    name='root_agent',
    description=(
        "Coordinates requirement analysis, user story generation, and test case creation by orchestrating specialized agents with Product Manager approval gates."
    ),
    instruction=(
        '''
        ...
        ### Your responsibilities:\n
        1. Act as the single entry point for user inputs such as Product Requirement Documments, Business Requirement Documents, Project Briefs, etc.\n
        ...
        2. Pause execution and present the output to the Product Manager.\n
            Check if the Requirements Agent needs further clarification based on the Product Manager's input.\n
            Ask the Product Manager if they would like to generate user stories based on the clarification they provided to the Requirement Agent's questions.\n
        ...
        * User Stories Output\n
        * Test Cases Output\n
        - Clearly indicate the current workflow state (e.g., 'Awaiting Product Manager Approval').\n\n
